...
public class ConverterService {
    ...
    public ConverterService() throws Exception {
        builder = factory.newDocumentBuilder();
    }
    /**
     * Сheck for empty text node
     */
    ...
    /**
     * Convert XML string into YAML
     *
     * @param sXml - XML string
     * @return return YAML format
     * @throws Exception throws all exception
     */
    private String сonvertString(Document sXml) throws Exception {
        String result = "";
        ...
        NodeList nlx = sXml.getDocumentElement().getChildNodes();
            ...
            for (String s : m.keySet()) {
                ...
                for (Node dnod: nd) {
                    if (nd.size() > 1) { //Change the name of tag to one for the List
                        sXml.renameNode(dnod, dnod.getNamespaceURI(), "listelem");
                    }
    ...
    /**
     * Parsing XML string to convert YAML
     *
     * @param input_xml - XML string
     * @return return YAML for user
     * @throws Exception throws all exception
     */
